...
public class ReqresNoPojoTest {
  ...
  public void checkAvatarsNoPojoTest() {
    ...
    Response response = given()
      ...
      .extract().response();
    // извлекли данные из ответа сервера в переменную response

    // данные их ответа засунули в новую Json
    JsonPath jsonPath = response.jsonPath();

    //Создаем списки с нужными нам атрибутами в Json для теста и сравнения
